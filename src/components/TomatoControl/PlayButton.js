    ...
    class PlayButton extends React.Component {
        ...
        render() {
            ...
            if (this.props.isRunning) {
                button = (
                    <svg className="pause--state" width="83px" height="82px" viewBox="0 0 83 82" version="1.1" xmlns="http://www.w3.org/2000/svg">
                ...
                button = (
                    <svg className="play--state" width="83px" height="82px" viewBox="0 0 83 82" version="1.1" xmlns="http://www.w3.org/2000/svg">
